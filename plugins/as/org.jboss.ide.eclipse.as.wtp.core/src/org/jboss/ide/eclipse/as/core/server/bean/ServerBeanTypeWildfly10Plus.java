...
public class ServerBeanTypeWildfly10Plus extends JBossServerType {
	...
	public static class ServerBeanTypeWildfly10PlusCondition extends AbstractCondition {
		...
		public String getFullVersion(File location, File systemFile) {
			File[] mods = new File[]{new File(location, "modules")};
			String vers = ServerBeanType.getManifestPropFromJBossModules(mods,
					"org.jboss.as.product", productFolder, WF_100_RELEASE_MANIFEST_KEY);
			if (vers == null) {
				vers = ServerBeanType.getManifestPropFromJBossModulesFolder(mods,
						"org.jboss.as.product", productFolder + "/dir/META-INF", WF_100_RELEASE_MANIFEST_KEY);
			}
			if (vers == null) {
				vers = ServerBeanType.getManifestPropFromJBossModules(mods,
						"org.jboss.as.server", "main", WF_100_RELEASE_MANIFEST_KEY);
			}
			if (vers == null) {
				vers = ServerBeanType.getManifestPropFromJBossModules(mods,
						"org.jboss.as.server", "main", "Implementation-Version");
			}
