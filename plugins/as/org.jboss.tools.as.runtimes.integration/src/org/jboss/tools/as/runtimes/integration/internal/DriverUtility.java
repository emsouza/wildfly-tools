...
public class DriverUtility implements IRuntimeIntegrationConstants {
	...
	static {
		...
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.EAP_80, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.WILDFLY_270, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
