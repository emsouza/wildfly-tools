...
public interface BasicStates {
	...
	public int STATE_EXPECTING_NONEMPTY_EXPRESSION = 105;
			// 1) "}"		--> EL
			// 2) NAME		--> call or assignment
	...
	public int STATE_EXPECTING_OPERATION = 400;
			...
			// 5) "]", "}"	--> array/set/map: call after method
	...
	public int STATE_EXPECTING_CALL = 201;
			// after an identifier "=" or "->" or a standard call
	public int STATE_EXPECTING_CALL_AFTER_IDENTIFIER = 203;
				// 5) "(" --> param
				// 6) "[" --> arg
