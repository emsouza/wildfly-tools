...
public class TimelineChart extends Chart implements IPropertyChangeListener {
    ...
    private void createChart(Composite parent) {
        ...
        Control plotAreaControl = (Control) getPlotArea();
        MyMouseListener plotAreaListener = new MyMouseListener(plotAreaControl);
        plotAreaControl.addListener(SWT.MouseMove, plotAreaListener);
        plotAreaControl.addListener(SWT.MouseDown, plotAreaListener);
        plotAreaControl.addListener(SWT.MouseUp, plotAreaListener);
    ...
    private class MyMouseListener implements Listener {
        ...
        public void handleEvent(Event event) {
            ...
            if (control instanceof Chart) {
                position = event.x - ((org.eclipse.swt.widgets.Control) getPlotArea()).getBounds().x;
            } else if (control instanceof org.eclipse.swtchart.internal.PlotArea) {
                position = event.x;
            } else {
